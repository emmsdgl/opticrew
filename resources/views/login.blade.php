...
<body>
    ...
    <!-- INTERACTIVE PICTURE START -->
        <div class="container-1 w-full md:w-1/2 flex flex-col justify-center" style="width:60%;padding:2em;">
            <div id="container-1-2" class="p-2 md:p-12 h-full flex flex-col justify-center items-center rounded-3xl"
                style="background-image: {url(/public/images/backgrounds/login_bg2.svg)};background-size: cover;">
                <h1 id="header1" class="text-5xl font-bold text-white mb-4 text-left w-11/12">
                    One-stop booking for
                    <span>
                        <p id="spotless_text" style="color:#0077FF;">a spotless space</p>
                    </span>
                </h1>
                <p id="desc1" class="text-base text-left mt-3 w-11/12" style="color: #688bffa8;">
        ...
        <div id="container-2" class="w-full md:w-1/2 flex justify-center items-center">
            <form action="/login" method="POST" class="space-y-4">
                <div id="container-2-1">
                    ...
                    <p id="login-header2">Welcome to Fin-noys</p>
                </div>
                ...
                <div class="input-group">
                    ...
                    <label for="input-username" class="text-gray-200 text-sm fam-regular">Email/Username</label>
                </div>
                ...
                <div class="input-group">
                    ...
                    <label for="input-password" class="text-gray-200 text-sm fam-regular">Password</label>
                </div>

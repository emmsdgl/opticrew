...
<body class="font-normal font-sans">
    ...
    <div class="flex flex-col md:flex-row min-h-screen w-full">
        ...
        <div class="container-1 hidden md:flex md:w-1/2 flex-col justify-center p-6 lg:p-10 xl:p-12">
            <div id="container-1-2"
                ...
                <x-liquid-ether :colors="['#1730F0', '#4169E1', '#93AAFF', '#0055FF']" :opacity="0.35" :mouse-force="18" :auto-demo="true" />
                ...
                <div class="absolute inset-0 z-[1] pointer-events-none overflow-hidden">
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2" style="bottom: 78%; width: 92%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-b-full backdrop-blur-sm bg-white/[0.04] border border-white/[0.12] border-t-0">
                        </div>
                    </div>
                    {{-- Middle ripple --}}
                    <div class="absolute left-1/2 -translate-x-1/2" style="bottom: 82%; width: 78%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-b-full backdrop-blur-sm bg-white/[0.03] border border-white/[0.07] border-t-0">
                        </div>
                    </div>
                    {{-- Inner ripple (most faded) --}}
                    <div class="absolute left-1/2 -translate-x-1/2" style="bottom: 86%; width: 64%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-b-full backdrop-blur-sm bg-white/[0.02] border border-white/[0.03] border-t-0">
                        </div>
                    </div>

                    {{-- BOTTOM ARC glow (bright blue, behind the arcs) --}}
                    <div class="absolute left-1/2 -translate-x-1/2 bottom-0"
                        style="width: 100%; height: 50%; transform: translateX(-50%);">
                        <div class="w-full h-full"
                            style="background: radial-gradient(ellipse 60% 70% at 50% 100%, rgba(59, 130, 246, 0.7) 0%, rgba(59, 130, 246, 0.4) 25%, rgba(37, 99, 235, 0.15) 50%, transparent 75%);">
                        </div>
                    </div>
                    ...
                    <div class="absolute left-1/2 -translate-x-1/2" style="top: 78%; width: 92%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-t-full backdrop-blur-sm bg-white/[0.04] border border-white/[0.12] border-b-0">
                        </div>
                    </div>
                    {{-- Middle ripple --}}
                    <div class="absolute left-1/2 -translate-x-1/2" style="top: 82%; width: 78%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-t-full backdrop-blur-sm bg-white/[0.03] border border-white/[0.07] border-b-0">
                        </div>
                    </div>
                    {{-- Inner ripple (most faded) --}}
                    <div class="absolute left-1/2 -translate-x-1/2" style="top: 86%; width: 64%; aspect-ratio: 2/1;">
                        <div
                            class="w-full h-full rounded-t-full backdrop-blur-sm bg-white/[0.02] border border-white/[0.03] border-b-0">
                        </div>
                    </div>
                </div>
                ...
                <div class="description-container flex flex-col justify-center items-center w-full my-3">
                    <h1 id="header1"
                        class="text-3xl sm:text-3xl lg:text-4xl font-sans font-bold text-white mb-4 text-left w-2/3 relative z-10">
                        One-stop booking for
                        <span class="aurora-text font-sans italic font-extrabold" id="spotless_text">a spotless
                            space</span>
                    </h1>

                    <p id="desc1"
                        class="text-blue-200 text-opacity-40 text-base text-left mt-3 w-2/3 relative z-10">
        ...
        <div id="container-2"
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-4 w-full max-w-md h-fit px-8">
                ...
                <div id="container-2-1" class="flex flex-col items-start my-12 w-full">
                    ...
                    <h1 id="login-header"
                        class="font-sans font-bold text-3xl sm:text-3xl lg:text-4xl mb-3 text-blue-950">Log In</h1>
                    <p id="login-header2"
                        class="text-[#07185788] font-sans font-normal text-sm sm:text-sm lg:text-base mb-3">Welcome to
                        Fin-noys</p>
                </div>
                ...
                @if (session('banned'))
                    <div x-data="{ showBanned: true }" x-show="showBanned"
                        x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0"
                        x-transition:enter-end="opacity-100"
                        class="fixed inset-0 z-[60] flex items-center justify-center p-4" style="display: none;">
                        <div class="absolute inset-0 bg-black/30"></div>
                        <div x-show="showBanned" x-transition:enter="transition ease-out duration-300 delay-100"
                            x-transition:enter-start="opacity-0 scale-90 translate-y-4"
                            x-transition:enter-end="opacity-100 scale-100 translate-y-0"
                            class="relative w-full max-w-sm bg-white rounded-2xl border border-gray-200 shadow-2xl overflow-hidden p-3">
                            <div class="px-8 pt-10 pb-6 flex flex-col items-center text-center">
                                <div
                                    class="w-14 h-14 rounded-full bg-red-100 border-2 border-red-400 flex items-center justify-center mb-6">
                                    <i class="fa-solid fa-ban text-red-500 text-2xl"></i>
                                </div>
                                <h3 class="text-lg font-bold text-gray-900 mb-2">Account Suspended</h3>
                                <p class="text-sm text-gray-500 leading-relaxed">Your account has been banned from
                                    accessing the system. If you believe this is a mistake, please contact Fin-noys
                                    support.</p>
                            </div>
                            <div class="px-8 pb-8 flex flex-col gap-3">
                                ...
                                <button @click="showBanned = false" type="button"
                                    class="w-full px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-sm rounded-xl transition-all duration-200">
                                    Close
                                </button>
                ...
                <div class="input-group" style="margin-bottom: 0.5rem;">
                    <span id="login-icon" class="icon"
                        style="transition: opacity 0.15s ease, transform 0.15s ease, color 0.15s ease; display: inline-flex; color: #0077FF;"><i
                            class="fa-solid fa-envelope"></i></span>
                    <input type="text" id="input-username" name="login"
                        class="bg-gray-100 text-xs sm:text-xs lg:text-sm" autocomplete="username">
                    <label for="input-username" class="text-[#07185788] text-sm font-sans">Email / Username</label>
                </div>
                <div id="login-validation"
                    class="text-sm h-5 flex items-center gap-1 ml-1 transition-all duration-200"
                    style="display: none;"></div>

                <!-- PASSWORD FIELD -->
                <div class="input-group relative group" style="margin-bottom: 0.5rem;" id="password-group">
                    <span id="password-icon" class="icon"
                        style="transition: opacity 0.15s ease, transform 0.15s ease, color 0.15s ease; display: inline-flex; color: #0077FF;"><i
                            class="fa-solid fa-key"></i></span>
                    <input type="password" id="input-password" name="password"
                        class="bg-gray-100 pr-10 text-xs sm:text-xs lg:text-sm disabled:opacity-40 disabled:cursor-not-allowed"
                        autocomplete="current-password" disabled>
                    <label for="input-password" class="text-[#07185788] text-sm font-sans">Password</label>

                    <a href="{{ route('forgot.password.new') }}" id="forgotPasswordIcon"
                        title="Forgot Password?"
                        class="absolute right-12 top-1/2 transform -translate-y-1/2 text-gray-300 hover:text-blue-500 focus:outline-none">
                ...
                <div class="mt-3 w-full items-center text-center" x-data="{
                    ...
                    <div x-show="!bothAccepted">
                        <div class="flex items-start space-x-2" id="terms-label">
                            <div class="relative mt-0.5 flex-shrink-0"
                                @click="if(!bothAccepted && (!termsOpened || !privacyOpened)) { window.showErrorDialog('Action Required', 'Please open and read both the Terms & Conditions and Privacy Policy before you can agree.'); }">
                            ...
                            <span class="text-xs text-gray-500 leading-relaxed text-center">
                                ...
                                <button type="button" id="terms-link"
                                    class="text-blue-600 hover:underline font-bold bg-transparent border-0 p-0 cursor-pointer text-xs">Terms
                                    & Conditions</button>
                                <span x-show="termsOpened" class="text-green-500 text-xs"><i
                                        class="fas fa-check-circle"></i></span>
                                and
                                <button type="button" id="privacy-link"
                                    class="text-blue-600 hover:underline font-bold bg-transparent border-0 p-0 cursor-pointer text-xs">Privacy
                                    Policy</button>
                                <span x-show="privacyOpened" class="text-green-500 text-xs"><i
                                        class="fas fa-check-circle"></i></span>.
                            </span>
                        </div>
                    </div>
                    <div x-show="bothAccepted" x-cloak>
                        <div class="flex items-start gap-2 text-green-600">
                            ...
                            <span class="text-xs sm:text-xs">The
                                <button type="button" id="terms-link-accepted"
                                    class="text-green-700 font-semibold underline hover:text-green-800 bg-transparent border-0 p-0 cursor-pointer text-xs inline">Terms
                                    & Conditions</button>
                                and
                                <button type="button" id="privacy-link-accepted"
                                    class="text-green-700 font-semibold underline hover:text-green-800 bg-transparent border-0 p-0 cursor-pointer text-xs inline">Privacy
                                    Policy</button>
                ...
                <div id="container-2-3" class="text-center text-sm mt-3">
                    <p id="donthaveacct" class="text-[#07185788] text-xs">
                        Don't have an account?
                        <button type="button" onclick="openRoleSelectionModal()" id="createacc-label" class="text-blue-600 font-bold ml-1 text-xs hover:underline bg-transparent border-0 p-0 cursor-pointer">Create account</button>
                    </p>
                </div>
    ...
    <div id="terms-modal" class="fixed inset-0 z-[250] flex items-center justify-center bg-black/50 p-4"
        style="display: none;">
        <div
            class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden">
            ...
            <div class="p-5 overflow-y-auto flex-1" id="terms-modal-content">
                <div class="space-y-4 text-gray-700 dark:text-gray-300">
                    ...
                    <p class="text-sm leading-relaxed">By accessing or using the Castcrew workforce management and
                        scheduling platform (the "System"), you ("User") agree to comply with and be bound by these
                        Terms and Conditions.</p>
                    <p class="text-sm leading-relaxed">If you do not agree with any part of these Terms, you must
                        refrain from using the System.</p>
                    <h3 class="text-base font-bold text-gray-900 dark:text-white mt-4">2. System Operations and
                        Allocation Rules</h3>
                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white mt-3">2.1 Workforce Allocation</h4>
                    <p class="text-sm leading-relaxed">Castcrew automatically determines the optimal number of
                        employees required for each task based on employee availability, pending workload, budget
                        constraints, and utilization targets.</p>
                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white mt-3">2.2 Team Composition and
                        Driver Requirement</h4>
                    <p class="text-sm leading-relaxed">Each assigned team must include at least one employee registered
                        as having valid driving skills.</p>
                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white mt-3">2.3 Task Prioritization</h4>
                    <p class="text-sm leading-relaxed">Tasks labeled with an "Arrival Status" are assigned the highest
                        scheduling priority.</p>
                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white mt-3">2.4 Schedule Generation and
                        Re-Optimization</h4>
                    <p class="text-sm leading-relaxed">Schedules are generated automatically. If a new task is added
                        before a schedule is finalized, the System will regenerate an optimized schedule.</p>
                    <h4 class="text-sm font-semibold text-gray-900 dark:text-white mt-3">2.5 Working Hours Compliance
                    </h4>
                    <p class="text-sm leading-relaxed">The System enforces a maximum of 12 working hours per day per
                        employee, in compliance with Finnish labor standards.</p>
                    <h3 class="text-base font-bold text-gray-900 dark:text-white mt-4">3. System Authority and Finality
                    </h3>
                    <p class="text-sm leading-relaxed">All task assignments and schedules are the outcome of automated,
                        rule-based optimization and are deemed final for operational purposes.</p>
                    <h3 class="text-base font-bold text-gray-900 dark:text-white mt-4">4. Modifications to System Rules
                    </h3>
                    <p class="text-sm leading-relaxed">Castcrew reserves the right to modify these Terms at any time.
                        Continued use constitutes acceptance of revised Terms.</p>
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700" x-data="{ alreadyAccepted: document.cookie.includes('finnoys_terms_accepted=1') }">
                <button x-show="!alreadyAccepted" type="button" @click="markTermsRead(); alreadyAccepted = true;"
                    class="w-full py-2.5 bg-[#0077FF] text-white text-sm font-semibold rounded-full hover:bg-blue-700 transition-colors">
                    I have read the Terms & Conditions
                </button>
                <button x-show="alreadyAccepted" x-cloak type="button" disabled
                    class="w-full py-2.5 bg-gray-300 dark:bg-gray-600 text-gray-500 dark:text-gray-400 text-sm font-semibold rounded-full cursor-not-allowed">
                    Already Agreed
                </button>
            </div>
        </div>
    ...
    <div id="privacy-modal" class="fixed inset-0 z-[250] flex items-center justify-center bg-black/50 p-4"
        style="display: none;">
        <div
            class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden">
            <div class="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700" x-data="{ alreadyAccepted: document.cookie.includes('finnoys_policy_accepted=1') }">
                <button x-show="!alreadyAccepted" type="button" @click="markPrivacyRead(); alreadyAccepted = true;"
                    class="w-full py-2.5 bg-[#0077FF] text-white text-sm font-semibold rounded-full hover:bg-blue-700 transition-colors">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.markTermsRead = function() {
                ...
                if (window.showSuccessDialog) window.showSuccessDialog('Terms Accepted',
            ...
            window.markPrivacyRead = function() {
                ...
                if (termsOpened && privacyOpened) enableGoogleBtn();
                if (window.showSuccessDialog) window.showSuccessDialog('Privacy Policy Accepted',
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function setMsg(el, type, text) {
                ...
                var c = {
                    error: 'text-red-500',
                    'error-noicon': 'text-red-500',
                    success: 'text-green-600',
                    'success-noicon': 'text-green-600',
            ...
            function setPasswordEnabled(enabled) {
                ...
                if (!enabled) {
                    passwordInput.value = '';
                    setMsg(passwordMsg, null, '');
                    prevP = '';
                    setPasswordStyle('reset');
                }
            }
            ...
            function checkPassword() {
                ...
                fetch('{{ route('auth.validate-login') }}', {
                    ...
                    if (d.password_checked) {
                        ...
                        if (d.password_valid) {
                            setMsg(passwordMsg, null, '');
                            setPasswordStyle(document.activeElement === passwordInput ? 'valid' :
                                'valid-blur');
                        } else {
                            setMsg(passwordMsg, 'error-noicon', 'Incorrect password');
            ...
            function debounceLogin() {
                clearTimeout(vTimer);
                vTimer = setTimeout(checkLogin, 300);
            }

            function debouncePassword() {
                clearTimeout(pwTimer);
                pwTimer = setTimeout(checkPassword, 400);
            }
            ...
            loginInput.addEventListener('focus', function() {
                if (accountFound) setLoginStyle('found');
            });
            loginInput.addEventListener('blur', function() {
                clearTimeout(vTimer);
                if (loginInput.value.trim()) {
                    checkLogin();
                    if (accountFound) setLoginStyle('found-blur');
                }
            });
            passwordInput.addEventListener('input', function() {
                ...
                setMsg(passwordMsg, null, '');
                prevP = '';
                if (accountFound && passwordInput.value) debouncePassword();
            });
            passwordInput.addEventListener('focus', function() {
                if (passwordValid) setPasswordStyle('valid');
            });
            passwordInput.addEventListener('blur', function() {
                clearTimeout(pwTimer);
                if (accountFound && passwordInput.value) checkPassword();
                if (passwordValid) setPasswordStyle('valid-blur');
            });
    ...
    {{-- Role Selection Modal (opens when "Create account" is clicked) --}}
    <x-partials.role-selection-modal />
</body>

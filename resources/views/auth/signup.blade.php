...
<head>
    ...
    <style>
        ...
        .input-container .input-field.has-value~label {
            top: -0.8rem;
            left: 1rem;
            font-size: 0.75rem;
            color: #0077FF;
        ...
        .input-container button.input-field.has-value~label {
            background-color: transparent;
        }

        .input-container button.input-field[disabled] {
            opacity: 0.5;
            cursor: not-allowed;
        }
        ...
        .input-container button.input-field {
            line-height: 1.25;
            min-height: 2.85rem;
        }
        ...
        .custom-dropdown-list.dropdown-above {
            top: auto;
            bottom: 100%;
            margin-top: 0;
...
<body class="bg-gray-50 font-sans">
    <main id="page-wrapper">
            ...
            <div id="stepper-container" class="w-full max-w-xl mx-auto">
                <div class="stepper-wrapper">
                    ...
                    <div id="step-1-indicator" class="step-item">
                        <div class="step-content-wrapper">
                            <div class="step-circle active">
                                <span text-gray-600>01</span>
                            </div>
                            <div class="step-label text-blue-600">Basic Details</div>
                            <div class="step-sublabel text-gray-500">Personal Info</div>
                        </div>
                        <div id="line-1-2" class="step-line"></div>
                    </div>
                    ...
                    <div id="step-2-indicator" class="step-item">
                        <div class="step-content-wrapper">
                            <div class="step-circle pending">
                                <span text-gray-600>02</span>
                            </div>
                            <div class="step-label text-gray-600">Verification</div>
                            <div class="step-sublabel text-gray-500">Email OTP</div>
                        </div>
                        <div id="line-2-3" class="step-line"></div>
                    </div>
                    ...
                    <div id="step-3-indicator" class="step-item">
                        <div class="step-content-wrapper">
                            <div class="step-circle pending">
                                <span text-gray-600>03</span>
                            </div>
                            <div class="step-label text-gray-600">Account Setup</div>
                            <div class="step-sublabel text-gray-500">Security & Login</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Content -->
        <section id="content-container" class="w-full py-4 px-4">
            <aside id="container-1" class="w-full p-3 md:p-5">
                <div id="inner-container-1">
                    <span id="form-status"
                        class="text-xs font-medium me-2 px-2.5 py-0.5 rounded-2xl bg-red-100 text-red-500">Incomplete</span>
                    <p id="step-label" class="text-base mt-5 text-blue-950 font-semibold">Step 1</p>
                    <h1 id="step-head" class="text-3xl sm:text-4xl md:text-5xl my-3 text-[#081032]">Basic Details</h1>
                    <p id="step-desc" class="text-gray-500 text-sm sm:text-sm"><span class="font-bold">First things
                            first</span>, let us
                        know your the following information for identification and
                        account verification purposes.</p>
                </div>
            </aside>
            <section id="container-2" class="w-full p-4 sm:p-8 md:p-12">
                ...
                <form method="POST" action="{{ route('register.client') }}">
                    ...
                    <!--                       STEP 1                           -->
                    <!-- ====================================================== -->
                    <div id="step-1" class="step-content w-full px-8">
                        <h1 id="form-head" class="mb-4 w-full text-center text-2xl font-semibold text-[#081032]">Tell Us
                            About You
                        </h1>

                        <div class="space-y-4">
                            <!-- Hidden Account Type - Always Personal -->
                            <input type="hidden" name="account_type" value="personal" id="account-type-personal">

                            <!-- Personal Account Fields -->
                            <div id="personal-fields" class="space-y-4">
                                <div id="name-layer"
                                    class="w-full flex flex-col sm:flex-row justify-between sm:space-x-3">
                                    <div class="flex-1">
                                ...
                                <div class="w-full flex flex-col sm:flex-row justify-between sm:space-x-3">
                                    <div class="input-container w-full sm:w-40 relative">
                                        <i
                                            class="fas fa-phone absolute left-4 top-1/2 transform -translate-y-1/2 text-[#081032] z-10"></i>
                                        <button id="dropdown-btn" type="button"
                                            class="input-field has-value w-full pl-12 pr-8 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 text-left text-sm cursor-pointer flex items-center gap-2">
                                        ...
                                        <div id="dropdown-list" class="custom-dropdown-list">
                                            <div class="custom-dropdown-item" data-value="+358"
                                                ...
                                                <img src="{{ asset('/images/icons/finland-flag.svg') }}"
                                            ...
                                            <div class="custom-dropdown-item" data-value="+46"
                                                ...
                                                <img src="{{ asset('/images/icons/sweden-flag.svg') }}"
                                                    alt="Sweden Flag" class="h-4 w-auto mr-2">
                                            ...
                                            <div class="custom-dropdown-item" data-value="+47"
                                                ...
                                                <img src="{{ asset('/images/icons/norway-flag.svg') }}"
                                                    alt="Norway Flag" class="h-4 w-auto mr-2">
                                            ...
                                            <div class="custom-dropdown-item" data-value="+45"
                                                ...
                                                <img src="{{ asset('/images/icons/denmark-flag.svg') }}"
                                                    alt="Denmark Flag" class="h-4 w-auto mr-2">
                                                <span class="text-sm">+45 Denmark</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex-1 input-container w-full relative">
                                        <i
                                ...
                                <div class="w-full flex flex-col sm:flex-row justify-between sm:space-x-3">
                                    ...
                                    <div class="input-container flex-1 relative">
                                        <i
                                            class="fas fa-map absolute left-4 top-1/2 transform -translate-y-1/2 text-[#081032] z-10"></i>
                                        <input type="hidden" id="input-state" name="state" class="w-4">
                                        <button type="button" id="state-dropdown-btn"
                                            class="input-field w-full pl-12 pr-8 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 text-left text-sm cursor-pointer">
                                        </button>
                                        <label class="bg-transparent">State / Region</label>
                                        <span
                                            class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <div id="state-dropdown-list"
                                            class="custom-dropdown-list dropdown-above max-h-48 overflow-y-auto">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-container flex-1 relative">
                                        <i
                                            class="fas fa-city absolute left-4 top-1/2 transform -translate-y-1/2 text-[#081032] z-10"></i>
                                        <input type="hidden" id="input-city" name="city">
                                        <button type="button" id="city-dropdown-btn"
                                            class="input-field w-full pl-12 pr-8 py-3 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 text-left text-sm cursor-pointer"
                                            disabled>
                                        </button>
                                        <label>City</label>
                            ...
                            <div id="buttons-container" class="flex justify-center gap-4 mt-6">
                                <button id="back1-btn" type="button"
                                    class="w-full sm:w-auto px-10 py-4 text-blue-600 border border-blue-600 hover:bg-blue-500 hover:text-white focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm">Cancel</button>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <div id="otp-container">
                                    <input id="otp1" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                    <input id="otp2" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                    <input id="otp3" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                    <input id="otp4" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                    <input id="otp5" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                    <input id="otp6" type="text" maxlength="1" pattern="\d"
                                        inputmode="numeric">
                                </div>
                    ...
                    <div id="step-3" class="step-content hidden">
                        ...
                        @if ($errors->any())
                            <div id="step3-errors"
                                class="mb-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative max-w-md mx-auto"
                                role="alert">
                        ...
                        <div id="step-3-personal" class="w-full space-y-4">
                            ...
                            <div class="input-container w-full max-w-md mx-auto relative">
                                ...
                                <button type="button" id="dropdown-secques1"
                                    class="security-question-btn1 select-field w-full pl-12 pr-4 py-4 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-gray-500 text-left font-normal">
                            ...
                            <div class="input-container w-full max-w-md mx-auto relative">
                                ...
                                <button type="button" id="dropdown-secques2"
                                    class="security-question-btn2 select-field w-full pl-12 pr-4 py-4 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm text-gray-500 text-left font-normal">
                                    Select a security question
                                </button>
                                <div
                                    class="security-question-dropdown z-10 absolute left-0 right-0 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-md w-full">
                            ...
                            <div class="input-container w-full max-w-md mx-auto relative">
                                <i
                                    class="fas fa-key absolute left-4 top-1/2 transform -translate-y-1/2 text-[#081032]"></i>
                                ...
                                <i class="fas fa-eye absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 cursor-pointer"
                                    id="togglePassword"></i>
                            </div>
                            <div class="input-container w-full max-w-md mx-auto relative">
                                <i
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const hasStep3Errors =
                {{ $errors->has('username') || $errors->has('password') || $errors->has('security_question') || $errors->has('security_answer_1') || $errors->has('security_answer_2') ? 'true' : 'false' }};
            ...
            // ===== PERSONAL ACCOUNT ONLY - NO ACCOUNT TYPE TOGGLE =====
            const accountTypePersonal = document.getElementById('account-type-personal');
            const personalFields = document.getElementById('personal-fields');

            // Ensure personal fields are visible and required
            if (personalFields) {
            ...
            // Ensure Step 3 personal account fields are required
            ...
            // ===== COUNTRY STATE CITY API - CASCADING DROPDOWNS =====
            const streetInput = document.getElementById('input-street');
            const stateHidden = document.getElementById('input-state');
            const cityHidden = document.getElementById('input-city');
            const stateBtn = document.getElementById('state-dropdown-btn');
            ...
            async function cscFetch(endpoint) {
                try {
                    ...
                    if (!response.ok) {
                        console.warn('CSC API error:', response.status);
                        return [];
                    }
            ...
            stateBtn.addEventListener('click', () => {
                ...
                stateDropdownList.classList.toggle('active');
            });
            cityBtn.addEventListener('click', () => {
                if (cityBtn.disabled) return;
                stateDropdownList.classList.remove('active');
                cityDropdownList.classList.toggle('active');
            });

            // Close dropdowns when clicking outside
            document.addEventListener('click', (e) => {
                if (!stateBtn.contains(e.target) && !stateDropdownList.contains(e.target)) {
                    stateDropdownList.classList.remove('active');
                }
                if (!cityBtn.contains(e.target) && !cityDropdownList.contains(e.target)) {
                    cityDropdownList.classList.remove('active');
                }
            });

            // 1. Load Finland states on page load
            async function loadStates() {
                ...
                states.sort((a, b) => a.name.localeCompare(b.name)).forEach(state => {
                    ...
                    item.className = 'custom-dropdown-item text-sm';
                    item.textContent = state.name;
                    item.dataset.value = state.name;
                    item.dataset.iso2 = state.iso2;
                    item.addEventListener('click', () => selectState(item));
                    stateDropdownList.appendChild(item);
                });
            }
            loadStates();

            // 2. When a state is selected, load cities
            async function selectState(item) {
                const stateName = item.dataset.value;
                const stateIso2 = item.dataset.iso2;

                stateHidden.value = stateName;
                stateBtn.textContent = stateName;
                stateBtn.classList.add('has-value');
                stateDropdownList.classList.remove('active');

                // Reset city
                cityHidden.value = '';
                cityBtn.textContent = '';
                cityBtn.classList.remove('has-value');
                cityBtn.disabled = true;
                cityDropdownList.innerHTML = '';

                const cities = await cscFetch(`/countries/${FINLAND_ISO2}/states/${stateIso2}/cities`);

                if (cities.length > 0) {
                    cities.sort((a, b) => a.name.localeCompare(b.name)).forEach(city => {
                        const cityItem = document.createElement('div');
                        cityItem.className = 'custom-dropdown-item text-sm';
                        cityItem.textContent = city.name;
                        cityItem.dataset.value = city.name;
                        cityItem.addEventListener('click', () => selectCity(cityItem));
            ...
            function selectCity(item) {
                cityHidden.value = item.dataset.value;
                cityBtn.textContent = item.dataset.value;
                cityBtn.classList.add('has-value');
                cityDropdownList.classList.remove('active');
                checkFormCompletion();
            }
            ...
            const allDropdownMenus = document.querySelectorAll('.dropdown-menu'); // Get all menus
            ...
            function updateStepper() {
                ...
                // Set header and description for current step
                stepHeader.textContent = stepNames[currentStep].name;
                stepDesc.textContent = stepNames[currentStep].desc;

                // ===== Manage required attributes based on current step =====
                const step1Personal = document.querySelectorAll('#personal-fields input');
                ...
                for (let i = 1; i <= totalSteps; i++) {
                    ...
                    const content = circle ? circle.querySelector('span') : null;
                    const labelEl = indicator.querySelector('.step-label');
                    const isCompleted = (i === 1 && isStep1Completed) || (i === 2 && isStep2Completed) || (i ===
                        3 && isStep3Completed);
                    ...
                    if (circle) {
                        ...
                        if (isCompleted) {
                            ...
                            if (labelEl) labelEl.className = 'step-label text-gray-900';
                        } else if (i === currentStep) {
                            circle.classList.add('active');
                            if (content) content.textContent = stepNumbers[i - 1];
                            if (labelEl) labelEl.className = 'step-label text-blue-700';
                        } else {
                            circle.classList.add('pending');
                            if (content) content.textContent = stepNumbers[i - 1];
                            if (labelEl) labelEl.className = 'step-label text-gray-500';
                        }
                    }
                }
                ...
                for (let i = 1; i < totalSteps; i++) {
                    ...
                    if (line) {
                        const isLineCompleted = (i === 1 && isStep1Completed) || (i === 2 && isStep2Completed);
                        if (isLineCompleted) {
                ...
                // Handle Step 3 content (personal account only)
                if (currentStep === 3) {
                    const step3Personal = document.getElementById('step-3-personal');
            ...
            function checkFormCompletion() {
                ...
                const selectedCountryCode = selectedCodeElement ? selectedCodeElement.textContent.replace('+', '') :
                    '358';

                // --- Form 1 Inputs (Personal Account Only) ---
                ...
                // --- 1. INDIVIDUAL FORM 1 CHECKS (Personal Account Only) ---
                ...
                const isStateComplete = state && state.value.trim() !== "";
                ...
                const isForm1Complete = isFNameComplete && isLNameComplete && isBDateComplete && isAgeValid &&
                    isEmailValid && isPhoneValid && isStreetComplete &&
                    isStateComplete && isCityComplete;
                ...
                // Check if ANY Step 1 field has data (personal account only)
                const isAnyStep1FieldPopulated =
                ...
                else if (isAnyStep1FieldPopulated || isAnyStep2FieldPopulated || isAnyStep3FieldPopulated ||
            ...
            const allFormInputs = document.querySelectorAll(
                ...
                '#input-street, #input-state, #input-city, ' +
            ...
            document.getElementById('next-1').addEventListener('click', (e) => {
                ...
                if (isForm1Complete) {
                    ...
                    // Get the email (personal account only)
                    const email = document.getElementById('input-email').value;
            ...
            // Back button for Step 3 (personal account only)
            document.getElementById('back3-btn').addEventListener('click', () => {
                currentStep = 2;
                updateStepper();
            });

            // Submit button for personal account
            ...
            function setupDropdown(buttonId, dropdownId, hiddenInputName, isPhoneDropdown = false) {
                ...
                const menuItems = dropdownId === 'dropdown-list' ? dropdownMenu.querySelectorAll(
                    '.custom-dropdown-item') : dropdownMenu.querySelectorAll('a');
                ...
                menuItems.forEach(item => {
                    item.addEventListener('click', (e) => {
                        ...
                        if (isPhoneDropdown) {
                            ...
                            const selectedText = item.querySelector('span').textContent.split(' ')[
                                0]; // Just take the code
                            const flagSrc = item.getAttribute('data-flag');
                            selectedFlag.src = flagSrc;
                ...
                document.addEventListener('click', (e) => {
                    if (dropdownButton && dropdownMenu && !dropdownButton.contains(e.target) && !

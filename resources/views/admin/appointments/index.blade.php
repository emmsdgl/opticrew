<x-layouts.general-employer :title="'Appointments'">
    <section class="flex flex-col w-full gap-6 p-4 md:p-6 min-h-[calc(100vh-4rem)]" x-data="appointmentDrawer()">
        ...
        <div>
                ...
                <div class="flex flex-row gap-2">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <div class="py-1">
                                <button type="button" @click="filterPendingByService('all'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">All
                                    Services</button>
                                <button type="button" @click="filterPendingByService('Final Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Final
                                    Cleaning</button>
                                <button type="button" @click="filterPendingByService('Deep Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Deep
                                    Cleaning</button>
                                <button type="button" @click="filterPendingByService('Snowout Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Snowout
                                    Cleaning</button>
                                <button type="button"
                                    @click="filterPendingByService('Daily Room Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Daily
                                    Room Cleaning</button>
                                <button type="button"
                                    @click="filterPendingByService('Hotel Cleaning Service'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Hotel
                                    Cleaning Service</button>
                                <button type="button" @click="filterPendingByService('Student Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Student
                                    Cleaning</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <div class="py-1">
                                <button type="button" @click="sortPendingByDate('desc'); open = false"
                                ...
                                <button type="button" @click="sortPendingByDate('asc'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2">
            ...
            <div id="pending-table-container" class="w-full overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Service</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Date
                                & Time</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Cabin
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Amount</th>
                    ...
                    <tbody>
                        @foreach($pendingAppointments as $appointment)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-800/50 pending-row"
                                data-service="{{ $appointment->service_type }}"
                                data-date="{{ $appointment->service_date->format('Y-m-d') }}">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if ($appointment->is_company_inquiry)
                                            <span
                                                class="px-2 py-0.5 text-xs font-medium rounded-full bg-purple-100 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400">
                                                Company
                                            </span>
                                        @endif
                                    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 dark:text-gray-200">
                                        {{ $appointment->service_type }}</div>
                                    <div class="text-xs text-gray-500 dark:text-gray-400">
                                        {{ $appointment->number_of_units }} unit(s) • {{ $appointment->unit_size }} m²
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 dark:text-gray-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200">
                                    {{ $appointment->cabin_name }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-200">
                                    €{{ number_format($appointment->total_amount, 2) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <button @click="openDrawer({{ $appointment->id }})"
            ...
            <div id="pending-filter-empty" class="w-full rounded-lg border-1 border-dashed border-gray-200 dark:border-gray-700 px-6 py-24 text-center" style="display: none;">
                ...
                <p class="text-xs mt-2 text-gray-400 dark:text-gray-500">No pending appointments match the selected filter.</p>
            </div>
            @else
            <div class="w-full rounded-lg border-1 border-dashed border-gray-200 dark:border-gray-700 px-6 py-24 text-center">
                ...
                <p class="text-base font-medium text-gray-500 dark:text-gray-400">No pending appointments</p>
                <p class="text-xs mt-2 text-gray-400 dark:text-gray-500">Pending appointment requests will appear here once clients submit them.</p>
            </div>
            @endif
        </div>
        ...
        <div>
                ...
                <div class="flex flex-row gap-2">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            class="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
                            <div class="py-1">
                                <button type="button" @click="filterApprovedByService('all'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">All
                                    Services</button>
                                <button type="button"
                                    @click="filterApprovedByService('Final Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Final
                                    Cleaning</button>
                                <button type="button" @click="filterApprovedByService('Deep Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Deep
                                    Cleaning</button>
                                <button type="button"
                                    @click="filterApprovedByService('Snowout Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Snowout
                                    Cleaning</button>
                                <button type="button"
                                    @click="filterApprovedByService('Daily Room Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Daily
                                    Room Cleaning</button>
                                <button type="button"
                                    @click="filterApprovedByService('Hotel Cleaning Service'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Hotel
                                    Cleaning Service</button>
                                <button type="button"
                                    @click="filterApprovedByService('Student Cleaning'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Student
                                    Cleaning</button>
                            </div>
                        </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
                            <div class="py-1">
                                <button type="button" @click="sortApprovedByDate('desc'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2">
                                    <i class="fas fa-arrow-down text-xs w-4"></i> Newest First
                                </button>
                                <button type="button" @click="sortApprovedByDate('asc'); open = false"
                                    class="w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center gap-2">
                                    <i class="fas fa-arrow-up text-xs w-4"></i> Oldest First
                                </button>
                            </div>
            ...
            <div id="approved-table-container" class="w-full overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                <table class="w-full">
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Date
                                & Time</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Team
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">
                                Amount</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach($assignedAppointments as $appointment)
                            <tr class="even:bg-gray-50 dark:even:bg-gray-800/50 approved-row"
                                data-service="{{ $appointment->service_type }}"
                                data-date="{{ $appointment->service_date->format('Y-m-d') }}"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if ($appointment->assignedTeam)
                                        <div class="text-sm text-gray-900 dark:text-gray-200">Team
                                            #{{ $appointment->assignedTeam->id }}</div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400">
        ...
        <div x-show="showDrawer" x-cloak class="fixed inset-0 z-50 overflow-hidden" style="display: none;">
            ...
            <div x-show="showDrawer" x-transition:enter="transition-opacity ease-out duration-300"
                ...
                x-transition:leave-end="opacity-0" @click="closeDrawer()"
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <template x-if="apt?.status === 'pending'">
                                    <span
                                        class="px-2.5 py-1 text-xs font-semibold rounded-full bg-orange-100 text-orange-700 dark:bg-orange-900/20 dark:text-orange-400">Pending</span>
                                </template>
                        ...
                        <template x-if="loading">
                            <div class="flex-1 flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Loading appointment details...
                                    </p>
                                </div>
                            </div>
                        </template>
                            ...
                            <div class="flex-1 overflow-y-auto p-6 space-y-6">
                                ...
                                <div>
                                    <h3
                                        ...
                                        <span
                                            x-text="apt.is_company_inquiry ? 'Company Information' : 'Client Information'"></span>
                                    </h3>
                                    <div class="space-y-0">
                                        <!-- Company fields -->
                                        <template x-if="apt.is_company_inquiry">
                                            <div>
                                                <div
                                                    ...
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Company
                                                        Name</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.company_name"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Contact
                                                        Person</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.first_name + ' ' + apt.client.last_name"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Business
                                                        ID</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.business_id || 'N/A'"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Email</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.email"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Phone</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.phone || 'N/A'"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span
                                                        class="text-sm text-gray-500 dark:text-gray-400">E-Invoice</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.einvoice_number || 'N/A'"></span>
                                                </div>
                                                <div class="flex justify-between items-start py-2.5">
                                                    ...
                                                    <span
                                                        ...
                                                        x-text="apt.client.address || 'N/A'"></span>
                                                </div>
                                            </div>
                                        </template>
                                        <!-- Personal fields -->
                                        <template x-if="!apt.is_company_inquiry">
                                            <div>
                                                ...
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Booking
                                                        Type</span>
                                                    <span
                                                        class="text-sm font-medium text-gray-900 dark:text-white capitalize"
                                                        x-text="apt.booking_type"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Email</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.user_email || apt.client.email"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Phone</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.client.user_phone || apt.client.phone || 'N/A'"></span>
                                                </div>
                                                <div class="flex justify-between items-start py-2.5">
                                                    <span
                                                        class="text-sm text-gray-500 dark:text-gray-400">Address</span>
                                ...
                                <div>
                                    <h3
                                        ...
                                        <span
                                            x-text="apt.is_company_inquiry ? 'Service Inquiry Details' : 'Service Details'"></span>
                                    </h3>
                                    ...
                                    <template x-if="apt.is_company_inquiry">
                                        <div class="space-y-3">
                                            <div>
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Requested
                                                    Services</p>
                                                <div class="flex flex-wrap gap-1.5">
                                                    <template x-for="svc in apt.service.company_service_types"
                                                        :key="svc">
                                                        <span
                                                            class="px-2.5 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 rounded-full text-xs font-medium"
                                                            x-text="svc"></span>
                                                    </template>
                                                    <template
                                                        x-if="!apt.service.company_service_types || apt.service.company_service_types.length === 0">
                                                        <span class="text-sm text-gray-500 dark:text-gray-400">No
                                                            services specified</span>
                                                    </template>
                                                </div>
                                            </div>
                                            <template x-if="apt.service.other_concerns">
                                                <div>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Additional
                                                        Information</p>
                                                    <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                                        <p class="text-sm text-gray-900 dark:text-white whitespace-pre-wrap"
                                                            x-text="apt.service.other_concerns"></p>
                                                    </div>
                                                </div>
                                            </template>
                                            <div
                                            ...
                                            <div class="space-y-0 mb-4">
                                                <div
                                                    ...
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Service
                                                        Type</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.service.service_type"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-center py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    <span class="text-sm text-gray-500 dark:text-gray-400">Units</span>
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.service.number_of_units + ' unit(s)'"></span>
                                                </div>
                                                <div
                                                    class="flex justify-between items-start py-2.5 border-b border-gray-100 dark:border-gray-700">
                                                    ...
                                                    <span
                                                        ...
                                                        <template x-if="apt.service.is_sunday">
                                                            <span
                                                                class="ml-1 text-xs text-orange-600 dark:text-orange-400 font-semibold">(Sunday)</span>
                                                        </template>
                                                        <template x-if="apt.service.is_holiday">
                                                            <span
                                                                class="ml-1 text-xs text-orange-600 dark:text-orange-400 font-semibold">(Holiday)</span>
                                                        </template>
                                                    </span>
                                                </div>
                                                <div class="flex justify-between items-center py-2.5">
                                                    ...
                                                    <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                        x-text="apt.service.service_time"></span>
                                                </div>
                                            </div>

                                            <!-- Unit Details -->
                                            <template
                                                x-if="apt.service.unit_details && apt.service.unit_details.length > 0">
                                                <div class="space-y-3">
                                                    <p
                                                        class="text-sm font-semibold text-gray-700 dark:text-white flex items-center gap-2">
                                                        <i class="fas fa-building text-gray-400"></i> Unit Details</p>
                                                    <template x-for="(unit, idx) in apt.service.unit_details"
                                                        :key="idx">
                                                        <div
                                            ...
                                            <template
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex gap-4 text-xs">
                                                        <span class="text-gray-600 dark:text-gray-400">Cabin: <span
                                                                class="font-medium text-gray-900 dark:text-white"
                                                                x-text="apt.service.cabin_name"></span></span>
                                                        <span class="text-gray-600 dark:text-gray-400">Size: <span
                                                                class="font-medium text-gray-900 dark:text-white"
                                                                x-text="apt.service.unit_size + ' m²'"></span></span>
                                                    </div>
                                                </div>
                                            </template>
                                ...
                                <template x-if="apt.is_company_inquiry">
                                    <div
                                        ...
                                        <h3
                                            class="text-sm font-semibold text-purple-900 dark:text-purple-400 mb-1 flex items-center">
                                        ...
                                        <div
                                            class="p-2 bg-white dark:bg-gray-800 rounded border border-purple-200 dark:border-purple-700">
                                            <p class="text-xs text-gray-500 dark:text-gray-400">Contact Email</p>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white"
                                                x-text="apt.client.email"></p>
                                        </div>
                                    </div>
                                </template>
                                ...
                                <template x-if="!apt.is_company_inquiry && apt.checklist && apt.checklist.length > 0">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Tasks to be completed
                                            by the assigned employee (read-only).</p>
                                        <div class="space-y-1.5">
                                            <template x-for="(item, idx) in apt.checklist" :key="idx">
                                                <div
                                                    ...
                                                    <div
                                                        class="w-4 h-4 mt-0.5 bg-gray-200 dark:bg-gray-600 rounded flex items-center justify-center flex-shrink-0">
                                                        <i
                                                            class="fas fa-circle text-gray-400 dark:text-gray-500 text-[5px]"></i>
                                                    </div>
                                        ...
                                        <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                            <div class="flex items-center justify-between">
                                                <span
                                                    class="text-xs font-medium text-gray-700 dark:text-gray-300">Checklist
                                                    Items</span>
                                                <span class="text-xs text-gray-500 dark:text-gray-400"
                                                    x-text="apt.checklist.length + ' items total'"></span>
                                            </div>
                                        </div>
                                    </div>
                                </template>
                                ...
                                <!-- Assigned Members -->
                                <template
                                    x-if="apt.team.assigned && apt.team.assigned.members && apt.team.assigned.members.length > 0">
                                    <div class="rounded-xl p-6 px-0 sshadow-sm">
                                        ...
                                        <div class="space-y-3">
                                            <template x-for="(m, i) in apt.team.assigned.members"
                                                :key="i">
                                                <div
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <template x-if="m.is_driver">
                                                            <p class="text-xs text-gray-500 dark:text-gray-400">Driver
                                                            </p>
                                                        </template>
                                                        <template x-if="!m.is_driver">
                                                            <p class="text-xs text-gray-500 dark:text-gray-400">Team
                                                                Member</p>
                                                        </template>
                                                    </div>
                                                </div>
                                ...
                                <template x-if="apt.status === 'rejected' && apt.rejection.reason">
                                    <div
                                        ...
                                        <h3
                                            class="text-sm font-semibold text-red-800 dark:text-red-400 mb-1 flex items-center">
                                            <i class="fi fi-rr-cross-circle mr-2"></i> Rejection Reason
                                        </h3>
                                        <p class="text-sm text-gray-900 dark:text-white"
                                            x-text="apt.rejection.reason"></p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"
                                            x-text="'Rejected by ' + apt.rejection.by + ' on ' + apt.rejection.at"></p>
                                    </div>
                                </template>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-0">
                                        <div
                                            ...
                                            <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                x-text="apt.timeline.submitted"></span>
                                        </div>
                                        <template x-if="apt.timeline.approved">
                                            <div
                                                ...
                                                <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                    x-text="apt.timeline.approved"></span>
                                            </div>
                                        </template>
                                        <template x-if="apt.timeline.rejected">
                                            <div class="flex justify-between items-center py-2.5">
                                                ...
                                                <span class="text-sm font-medium text-gray-900 dark:text-white"
                                                    x-text="apt.timeline.rejected"></span>
                                            </div>
                                        </template>
                                    </div>
                                </div>
        ...
        function appointmentDrawer() {
            return {
                ...
                filterPendingByService(service) {
                    ...
                    rows.forEach(row => {
                        if (service === 'all') {
                            ...
                            const match = row.getAttribute('data-service') === service;
                            row.style.display = match ? '' : 'none';
                            if (match) visibleCount++;
                        }
                    });
                    const tableContainer = document.getElementById('pending-table-container');
                    const filterEmpty = document.getElementById('pending-filter-empty');
                    if (tableContainer) tableContainer.style.display = visibleCount > 0 ? '' : 'none';
                ...
                filterApprovedByService(service) {
                    ...
                    const tableContainer = document.getElementById('approved-table-container');
                    const filterEmpty = document.getElementById('approved-filter-empty');
                    if (tableContainer) tableContainer.style.display = visibleCount > 0 ? '' : 'none';
                    if (filterEmpty) filterEmpty.style.display = visibleCount > 0 ? 'none' : '';
                },

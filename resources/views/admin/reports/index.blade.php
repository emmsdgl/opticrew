<x-layouts.general-employer :title="'Reports'">
    <section class="flex flex-col w-full gap-6 p-4 md:p-6 min-h-[calc(100vh-4rem)]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('admin.reports.performance.index') }}" class="group bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-all p-6 border-2 border-transparent hover:border-amber-500">
                <div class="flex items-start justify-between mb-4">
                    <div class="p-3 bg-amber-100 dark:bg-amber-900/20 rounded-lg">
                        <i class="fi fi-rr-chart-user text-amber-600 dark:text-amber-400 text-2xl"></i>
                    </div>
                    <i class="fi fi-rr-arrow-right text-gray-400 group-hover:text-amber-600 transition-colors"></i>
                </div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Conduct monthly evaluations and manage performance improvement plans
                </p>

                <div class="mt-4 flex items-center gap-2 text-amber-600 dark:text-amber-400 font-medium text-sm">
                    View Report
                    <i class="fi fi-rr-angle-right text-xs"></i>
                </div>
            </a>
            ...
            <a href="{{ route('admin.reports.attendance') }}" class="group bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition-all p-6 border-2 border-transparent hover:border-teal-500">
                <div class="flex items-start justify-between mb-4">
                    <div class="p-3 bg-teal-100 dark:bg-teal-900/20 rounded-lg">
                        <i class="fi fi-rr-calendar-check text-teal-600 dark:text-teal-400 text-2xl"></i>
                    </div>
                    <i class="fi fi-rr-arrow-right text-gray-400 group-hover:text-teal-600 transition-colors"></i>
                </div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    View absences and approved leave requests
                </p>

                <div class="mt-4 flex items-center gap-2 text-teal-600 dark:text-teal-400 font-medium text-sm">
                    View Report
                    <i class="fi fi-rr-angle-right text-xs"></i>
                </div>
            </a>

<x-layouts.general-employer :title="'Admin Dashboard'">
    <x-skeleton-page :preset="'dashboard'">
        <section class="flex flex-col lg:flex-row gap-6 p-4 md:p-6 flex-1">
            ...
            <div class="flex flex-col gap-6 flex-1 w-full">
                ...
                <div class="flex flex-col gap-4" x-data="{
                    ...
                    <div x-show="showTaskDrawer" x-cloak class="fixed inset-0 z-50 overflow-hidden"
                        style="display: none;">
                        <!-- Backdrop -->
                        <div x-show="showTaskDrawer" x-transition:enter="transition-opacity ease-out duration-300"
                            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                            x-transition:leave="transition-opacity ease-in duration-200"
                            x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                            @click="closeTaskDrawer()" class="absolute inset-0 bg-black/50 dark:bg-black/70"></div>
                        ...
                        <div class="fixed inset-y-0 right-0 flex max-w-full">
                            <div x-show="showTaskDrawer"
                                ...
                                @click.stop class="relative w-screen max-w-sm">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Task Details
                                        </h2>
                                    ...
                                    <div class="flex-1 overflow-y-auto p-6" x-show="selectedTask">
                                        ...
                                        <div class="flex items-center gap-2 mb-6">
                                            ...
                                            <span class="px-3 py-1 text-xs rounded-full font-semibold"
                                                :class="{
                                                    ...
                                                    'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400': getTaskStatus() === 'Pending' ||
                                                        getTaskStatus() === 'Scheduled',
                                                    'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300': ![
                                                        'Completed', 'In Progress', 'Pending', 'Scheduled'
                                                    ].includes(getTaskStatus())
                                                }"
                                        ...
                                        <div class="mb-5">
                                            <div class="py-3">
                                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">
                                                    Service Details</h4>
                                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">View the
                                                    details of the service for this task</p>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <!-- Service Time -->
                                                <div class="flex justify-between items-center">
                                                    <span class="text-gray-500 dark:text-gray-400">Service Time (Due
                                                        at)</span>
                                                    <span class="font-medium text-gray-900 dark:text-white text-right"
                                                ...
                                                <!-- Location -->
                                                <div class="flex justify-between items-center"
                                                    x-show="selectedTask?.modal_data?.location">
                                        ...
                                        <div class="mb-5"
                                            x-show="selectedTask?.modal_data?.team_members && selectedTask.modal_data.team_members.length > 0">
                                            <div class="py-3">
                                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">
                                                    Assigned Team</h4>
                                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-3"
                                                    x-text="selectedTask?.modal_data?.team_name || 'Team members assigned to this task'">
                                                </p>
                                            </div>

                                            <div
                                                class="flex items-center gap-2 flex-wrap px-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                                                <template
                                                    x-for="(member, idx) in (selectedTask?.modal_data?.team_members || []).slice(0, 5)"
                                                    :key="idx">
                                                ...
                                                <template
                                                    x-if="(selectedTask?.modal_data?.team_members?.length || 0) > 5">
                                                    <button
                                                        class="w-10 h-10 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-full flex items-center justify-center text-gray-400 text-sm"
                                        ...
                                        <div class="mb-5">
                                            <div class="py-3">
                                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">
                                                    Task Duration</h4>
                                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">Actual start
                                                    and end time of the task</p>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <!-- Estimated Duration -->
                                                <div class="flex justify-between items-center"
                                                    x-show="selectedTask?.modal_data?.estimated_duration">
                                                    <span class="text-gray-500 dark:text-gray-400">Estimated
                                                        Duration</span>
                                                    <span class="font-medium text-gray-900 dark:text-white text-right"
                                        ...
                                        <div class="mb-5">
                                            <div class="py-3">
                                                ...
                                                <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">
                                                    ...
                                                    <template
                                                        x-if="getTaskStatus() !== 'Completed' && getTaskStatus() !== 'In Progress'">
                                            ...
                                            <template
                                                x-if="getTaskStatus() === 'In Progress' && getChecklistProgress().completed > 0">
                                                <div
                                                    class="mb-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                                    <div class="flex items-center gap-2">
                                                        <i
                                                            class="fas fa-spinner fa-spin text-blue-600 dark:text-blue-400"></i>
                                                        <span
                                                    ...
                                                    <p class="text-xs text-blue-600 dark:text-blue-400 mt-1 ml-6">
                                                        <span x-text="getChecklistProgress().completed"></span> of
                                                        <span x-text="getChecklistProgress().total"></span> checklist
                                                        items completed
                                                    </p>
                                                </div>
                                            </template>
                                            ...
                                            <template x-if="getTaskStatus() === 'Completed'">
                                                <div
                                                    class="mb-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                                                    <div class="flex items-center gap-2">
                                                        <i
                                                            class="fas fa-check-circle text-emerald-600 dark:text-emerald-400"></i>
                                                        <span
                                                    ...
                                                    <p
                                                        class="text-xs text-emerald-600 dark:text-emerald-400 mt-1 ml-6">
                                            ...
                                            <!-- Checklist Items -->
                                            <div
                                                class="space-y-2 max-h-48 overflow-y-auto bg-gray-50 dark:bg-gray-800/50 rounded-lg p-3">
                                                <template x-for="(item, index) in getChecklistItems()"
                                                    :key="index">
                                                    <div class="flex items-center gap-2 py-1.5">
                                                        <!-- Single icon based on status -->
                                                        <i class="text-xs"
                                                            :class="{
                                                                'fa-solid fa-check-circle text-emerald-500': getTaskStatus() === 'Completed' ||
                                                                    (getTaskStatus() === 'In Progress' &&
                                                                        isChecklistItemCompleted(index)),
                                                                'fa-regular fa-circle text-blue-400': getTaskStatus() === 'In Progress' &&
                                                                    !isChecklistItemCompleted(index),
                                                                'fa-regular fa-circle text-gray-400': getTaskStatus() !== 'Completed' &&
                                                                    getTaskStatus() !== 'In Progress'
                                                            }"></i>
                                                        <span class="text-sm"
                                                            :class="{
                                                                'text-emerald-700 dark:text-emerald-300 font-medium': getTaskStatus() === 'Completed' ||
                                                                    (getTaskStatus() === 'In Progress' &&
                                                                        isChecklistItemCompleted(index)),
                                            ...
                                            <!-- Progress bar -->
                                            <template
                                                x-if="getTaskStatus() === 'In Progress' || getTaskStatus() === 'Completed'">
                                                <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                                    <div class="flex items-center justify-between mb-1">
                                                        <span
                                                            class="text-xs font-medium text-gray-600 dark:text-gray-400">Progress</span>
                                                        <span class="text-xs font-semibold"
                                                            :class="{
                                                                'text-emerald-600 dark:text-emerald-400': getChecklistProgress()
                                                                    .percentage === 100 ||
                                                                getTaskStatus() === 'Completed',
                                                                'text-blue-600 dark:text-blue-400': getChecklistProgress()
                                                                    .percentage > 0 && getChecklistProgress()
                                                                    .percentage < 100 &&
                                                                getTaskStatus() !== 'Completed',
                                                                'text-gray-600 dark:text-gray-400': getChecklistProgress()
                                                                    .percentage === 0 &&
                                                                getTaskStatus() !== 'Completed'
                                                            }">
                                                            <span
                                                                x-text="getTaskStatus() === 'Completed' ? '100' : getChecklistProgress().percentage"></span>%
                                                            Complete
                                                        </span>
                                                    </div>
                                                    <div
                                                        ...
                                                        <div class="h-1.5 rounded-full transition-all duration-300"
                                                            :class="{
                                                                'bg-emerald-600': getChecklistProgress().percentage ===
                                                                    100 || getTaskStatus() === 'Completed',
                                                                'bg-blue-600': getChecklistProgress().percentage > 0 &&
                                                                    getChecklistProgress().percentage < 100 &&
                                                                    getTaskStatus() !== 'Completed',
                                                                'bg-gray-400': getChecklistProgress().percentage ===
                                                                    0 && getTaskStatus() !== 'Completed'
                                                            }"
                                                            :style="'width: ' + (getTaskStatus() === 'Completed' ? '100' :
    ...
    <x-guided-tour tourName="admin-dashboard" :steps="json_encode([
        [
            ...
            'description' =>
                'This is your central hub for managing the entire system. Let us walk you through the key features available to you.',
            'side' => 'bottom',
            'align' => 'center',
        ],
        [
            ...
            'description' =>
                'Access all major sections from here: Accounts, Tasks, Appointments, Recruitment, Training, Attendance, History, and Analytics.',
            'side' => 'right',
            'align' => 'start',
        ],
        [
        ...
        [
            ...
            'title' => 'Task Overview',
            'description' =>
                'Monitor all scheduled tasks here. Click any task to view its full details, assigned team, and checklist progress.',
            'side' => 'top',
            'align' => 'center',
        ],
        [
            ...
            'description' =>
                'Track employee attendance stats and see who recently clocked in. This panel updates automatically.',
            'side' => 'left',
            'align' => 'start',
        ],
    ])" />

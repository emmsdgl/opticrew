@props([
    'services' => [],             // The array to loop through
    'onBook' => '',               // JS function for booking
    'onFavorite' => '',           // JS function for favorite toggle
])
                ...
                <div class="flex items-start justify-between mb-3">
                    ...
                    @if(!empty($service['badge']))
                        <div class="flex items-center gap-2 px-3 py-1 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                            ...
                            <span class="text-xs font-semibold text-blue-600 dark:text-blue-400">{{ $service['badge'] }}</span>
                        </div>
                    @endif

{{-- Reusable Error Dialog (apply-modal style + spring animation) --}}
@props([
    'show' => 'showError',
...
>
    ...
    >
        ...
        <button type="button"
            {{ $attributes->merge(['class' => 'w-full py-2 rounded-xl text-xs font-bold border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors']) }}>
            {{ $buttonText }}
        </button>
    </div>
</div>

...
<body class="bg-[#F3F3F3] text-gray-700 dark:bg-[#0F172A] dark:text-gray-100 font-sans transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
        ...
        <x-sidebar :nav_option_1="'Dashboard'" :nav_option_2="'Accounts'" :nav_option_3="'Tasks'" :nav_option_4="'Appointments'"
            :nav_option_5="'Teams'" :nav_option_6="'Analytics'" :team_name_1="'HR Team'" :team_name_2="'Tech Team'"
            :team_name_3="'Design Team'" />

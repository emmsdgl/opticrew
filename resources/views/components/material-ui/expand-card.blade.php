...
<div class="carousel-card group relative overflow-hidden rounded-3xl cursor-pointer transition-all duration-500 ease-out border border-transparent"
    data-card="{{ $index }}" data-glow-color="{{ $glowColor }}" style="flex: 1; min-width: 100px;">

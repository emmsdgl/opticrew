-- =====================================================
-- STEP 2: IMPORT ALL TABLESPACES AND RECREATE INDEXES
-- =====================================================
-- Run this AFTER you have copied ALL .ibd files to C:\xampp\mysql\data\opticrew\
-- =====================================================
...
SELECT 'RECOVERY COMPLETE! Your data has been restored.' AS Status;
